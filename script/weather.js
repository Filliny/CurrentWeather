...
function fillHourly(){
    ...
    for(let i = 0; i < weatherArr.length; i++){
        ...
        hourElement.style.gridColumn = (3+i).toString();
        ...
        windElement.style.gridColumn = (3+i).toString();
